...
sandbox:safe_primitive(pengineService:busca_alunos_contaminados_por_turma_e_semestre(_,_,_,_)).
sandbox:safe_primitive(pengineService:busca_quantidade_de_alunos_contaminados_por_turma_e_semestre(_,_,_,_)).
sandbox:safe_primitive(pengineService:busca_alunos_contaminados_por_turma_e_cidade(_,_,_,_)).
sandbox:safe_primitive(pengineService:busca_alunos_contaminados_por_veiculo(_,_,_)).
sandbox:safe_primitive(pengineService:busca_alunos_suspeitos_por_turma_e_semestre(_,_,_,_)).
sandbox:safe_primitive(pengineService:busca_quantidade_de_alunos_suspeitos_por_turma_e_semestre(_,_,_,_)).
sandbox:safe_primitive(pengineService:busca_alunos_suspeitos_por_turma_e_cidade(_,_,_,_)).
sandbox:safe_primitive(pengineService:busca_alunos_suspeitos_por_veiculo(_,_,_)).
sandbox:safe_primitive(pengineService:busca_alunos_mortos_por_turma_e_semestre(_,_,_,_)).
sandbox:safe_primitive(pengineService:busca_quantidade_de_alunos_mortos_por_turma_e_semestre(_,_,_,_)).
sandbox:safe_primitive(pengineService:busca_alunos_mortos_por_turma_e_cidade(_,_,_,_)).
sandbox:safe_primitive(pengineService:busca_alunos_mortos_por_veiculo(_,_,_)).
sandbox:safe_primitive(pengineService:busca_professores_contaminados_por_turma_e_semestre(_,_,_,_)).
sandbox:safe_primitive(pengineService:busca_quantidade_de_professores_contaminados_por_turma_e_semestre(_,_,_,_)).
sandbox:safe_primitive(pengineService:busca_professores_contaminados_por_turma_e_cidade(_,_,_,_)).
sandbox:safe_primitive(pengineService:busca_professores_contaminados_por_veiculo(_,_,_)).
sandbox:safe_primitive(pengineService:busca_professores_suspeitos_por_turma_e_semestre(_,_,_,_)).
sandbox:safe_primitive(pengineService:busca_quantidade_de_professores_suspeitos_por_turma_e_semestre(_,_,_,_)).
sandbox:safe_primitive(pengineService:busca_professores_suspeitos_por_turma_e_cidade(_,_,_,_)).
sandbox:safe_primitive(pengineService:busca_professores_suspeitos_por_veiculo(_,_,_)).
sandbox:safe_primitive(pengineService:busca_professores_mortos_por_turma_e_semestre(_,_,_,_)).
sandbox:safe_primitive(pengineService:busca_quantidade_de_professores_mortos_por_turma_e_semestre(_,_,_,_)).
sandbox:safe_primitive(pengineService:busca_professores_mortos_por_turma_e_cidade(_,_,_,_)).
sandbox:safe_primitive(pengineService:busca_professores_mortos_por_veiculo(_,_,_)).
...
sandbox:safe_primitive(pengineService:busca_alunos_parentes_de_outro_aluno_infectado(_,_,_)).
sandbox:safe_primitive(pengineService:busca_professores_parentes_de_outro_professor_infectado(_,_,_)).
sandbox:safe_primitive(pengineService:busca_turmas_de_um_professor_confirmado(_,_)).
sandbox:safe_primitive(pengineService:busca_turmas_de_um_professor_com_suspeita(_,_)).
